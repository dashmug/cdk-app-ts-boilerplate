...
const checks = [
	...
	// Check for serverless best practices. Serverless Checks are a
	// compilation of rules to validate infrastructure-as-code template
	// against recommended practices.
	new ServerlessChecks({ verbose: true }),

	// Check for HIPAA Security compliance. Based on the HIPAA Security
